...
window.onload = () => {
  ...
  xml.open("POST", "../models/questionsModel.php", true);
  xml.send();
};
...
function showQuestion() {
  ...
  currentQuestion.answer_text.forEach((reponse) => {
    const button = document.createElement("button");
    button.innerText = reponse.answer_text;
